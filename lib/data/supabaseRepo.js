...
export default function makeSupabaseRepo() {
  return {
    ...
    async init() {
      ...
      return { ...ctx, user, accounts: b.accounts || [], categories: b.categories || [], rates, stale };
    },
    /**
    ...
    shopping: {
      ...
      async addItem(i) { return must(await sb().rpc('shopping_add_item', { p_name: i.name, p_list_id: i.list_id ?? null, p_qty: i.qty ?? null })); },
