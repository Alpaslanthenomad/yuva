 ...
 * @property {{get:()=>Promise<Object>, update:(patch:Object)=>Promise<Object>}} household
 * @property {{list:()=>Promise<Object[]>, create:(m:Object)=>Promise<Object>, update:(id:string,patch:Object)=>Promise<Object>}} members
 * @property {{list:(q:{from:string,to:string})=>Promise<Object[]>, create:(e:Object)=>Promise<Object>, update:(id:string,patch:Object)=>Promise<Object>, remove:(id:string)=>Promise<void>}} events
 ...
 * @property {{list:(period:string)=>Promise<Object[]>, set:(b:Object)=>Promise<Object>}} budgets
 ...
 * @property {{list:()=>Promise<Object[]>, create:(t:Object)=>Promise<Object>, toggle:(id:string)=>Promise<Object>}} tasks
 ...
 * @property {{month:(period:string)=>Promise<Object>, budgetStatus:(period:string)=>Promise<Object[]>, agenda:(from:string,days:number)=>Promise<Object>}} summary
 * @property {{rates:()=>Promise<Object>}} fx
 * @property {{signInWithEmail:(email:string)=>Promise<void>, signOut:()=>Promise<void>, createHousehold:(p:Object)=>Promise<string>, joinHousehold:(code:string)=>Promise<string>}} auth
 */
export {};
