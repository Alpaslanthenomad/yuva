 ...
 * @property {{lists:()=>Promise<Object[]>, items:(listId?:string)=>Promise<Object[]>, addItem:(i:Object)=>Promise<Object>, toggleItem:(id:string)=>Promise<Object>, clearChecked:(listId:string)=>Promise<void>, checkout:(listId:string,txn:Object)=>Promise<Object>}} shopping
