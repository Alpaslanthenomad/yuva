 ...
 * @property {{list:(period:string)=>Promise<Object[]>, set:(b:Object)=>Promise<Object>, remove:(period:string,categoryId:string|null)=>Promise<void>, setPersonalLimit:(amount:number)=>Promise<void>}} budgets
 * @property {{list:()=>Promise<Object[]>, create:(r:Object)=>Promise<Object>, update:(id:string,patch:Object)=>Promise<Object>, remove:(id:string)=>Promise<void>, pay:(id:string,opts?:{date?:string,amount?:number,accountId?:string})=>Promise<Object>, skip:(id:string)=>Promise<string>}} recurring
 * @property {{list:()=>Promise<Object[]>, get:(id:string)=>Promise<Object>, items:(planId:string)=>Promise<Object[]>, create:(p:Object)=>Promise<Object>, update:(id:string,patch:Object)=>Promise<Object>, addItem:(i:Object)=>Promise<Object>, updateItem:(id:string,patch:Object)=>Promise<Object>, removeItem:(id:string)=>Promise<void>, remove:(id:string)=>Promise<void>, contributions:(planId:string)=>Promise<Object[]>, addContribution:(c:Object)=>Promise<Object>}} plans
 ...
 * @property {{url:(path:string)=>Promise<string|null>, attach:(txnId:string,file:File,oldPath?:string)=>Promise<string>, remove:(txnId:string,path:string)=>Promise<void>}} receipts
