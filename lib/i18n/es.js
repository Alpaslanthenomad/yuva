...
const es = {
  ...
  nav: { today: 'Hoy', calendar: 'Calendario', money: 'Dinero', plans: 'Planes', family: 'Familia', settings: 'Ajustes', myday: 'Mi día' },
  ...
  money: {
    title: 'Dinero', overview: 'Resumen', transactions: 'Movimientos', report: 'Reporte', budgets: 'Presupuesto', bills: 'Recurrentes', accounts: 'Cuentas',
